...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_OGLW_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_OGLW_t qt_meta_stringdata_OGLW = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_OGLW[] = {
...
Q_CONSTINIT const QMetaObject OGLW::staticMetaObject = { {
    QMetaObject::SuperData::link<QOpenGLWidget::staticMetaObject>(),
    qt_meta_stringdata_OGLW.offsetsAndSizes,
    qt_meta_data_OGLW,
    qt_static_metacall,
    nullptr,
...
void OGLW::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (OGLW::*)();
            if (_t _q_method = &OGLW::mouseMove; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
